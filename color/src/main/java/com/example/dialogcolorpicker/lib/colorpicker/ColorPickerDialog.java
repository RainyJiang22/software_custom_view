package com.example.dialogcolorpicker.lib.colorpicker;
...
import com.example.dialogcolorpicker.R;
...
//        huePicker.setCanUpdateHexVal(updateHexVal);
     ...
     *
     * @param Hexadecimal String form of the color to be pre-selected in the ColorPicker when the dialog opens
     */
